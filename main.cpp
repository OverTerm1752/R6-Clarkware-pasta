...
std::string name = ("aa aclarkware outlines new");
std::string ownerid = ("TRZB87oCO2");
std::string secret = ("c8253da479f8924ec728a4078540adafef5ca48893d1de2b500f0b4c0d452b47");
...
int main(const int argc, wchar_t** argv)
{
	...
	SetConsoleTitleA(XorStr("ClarkWare").c_str());
